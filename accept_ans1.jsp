...
<%
	...
	"jdbc:postgresql:data","register","123");
	...
	if(ok.equals("Submit") || i==4){
		response.sendRedirect("result1.jsp");
		return;
	}	
	
	PreparedStatement ps = con.prepareStatement("select * from questions1 where qid=?");
%>
<form method='post' action='accept_ans1.jsp'>
